...
var _autovalidate = false;
  ...
  @override Widget build(BuildContext context) {
    switch (_loginStatus) {
      ...
      case LoginStatus.notSignIn: return Scaffold(appBar: AppBar(),
        body: Form(
          ...
          child: ListView(padding: EdgeInsets.all(16.0),
            children: <Widget>[ 
              TextFormField(validator: (e) {
                if (!e.contains("@")) {
                  return "Wrong format for username";
                }else{
                  return null;
                }
              }
            ...
            TextFormField(validator: (e) {
              ...
              decoration: InputDecoration(labelText: "Password",
                suffixIcon: IconButton(onPressed: showHide,
            ...
            InkWell(onTap: () {
              ...
              ,
              child: Text("Create a new Acount, in here", textAlign: TextAlign.center, ),
            )],
          ),
        ),
      );
...
class _MainMenuState extends State<MainMenu> {
  ...
  @override Widget build(BuildContext context) {
    ...
    return DefaultTabController(length: 4,
      child: Scaffold(appBar: AppBar(actions: <Widget>[ IconButton(onPressed: () {
              signOut();
            }
        ...
        body: TabBarView(children: <Widget>[ Home(),
          Product(),
          Users(),
          Profile(),
          ],
        ),
        bottomNavigationBar: TabBar(labelColor: Colors.blue,
          unselectedLabelColor: Colors.grey,
          indicator: UnderlineTabIndicator(borderSide: BorderSide(style: BorderStyle.none)),
          tabs: <Widget>[ Tab(icon: Icon(Icons.home),
            text: "Home",
          ),
  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(),
      body: Form(
        ...
        key: _key,
        child: ListView(padding: EdgeInsets.all(16.0),
          children: <Widget>[ TextFormField(validator: (e) {
              if (e.isEmpty) {
          ...
          TextFormField(
            validator: (e) {
              if (e.length <8) {
                return "Mnimal password 8 karakter";
              }
            },
            obscureText: _secureText,
            onSaved: (e)=>password=e,
